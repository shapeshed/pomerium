...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ingress.pomerium.io/default-cert-secret`             | When a certificate is provided here in the format `namespace/secret_name`, it will be used as the default certificate for the Ingress.                                                                                                                                                                                              |
